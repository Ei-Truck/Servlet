    ...
    private void inserirAdministrador(HttpServletRequest request, HttpServletResponse response, String acao, String sub_acao) throws IOException, ServletException {
        ...
        try {
            ...
            if (success) {
                ...
                errorMessage = "Erro ao cadastrar administrador, o e-mail ou CPF já existe no banco de dados.";
            }
        ...
        if (respacher != null) {
            ...
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "\"Erro ao cadastrar administrador, o e-mail ou CPF já existe no banco de dados.\"");
        }
    }
