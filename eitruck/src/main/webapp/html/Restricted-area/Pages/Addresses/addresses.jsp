  ...
  <div class="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li><a href="../Administrator/processar_administrador.jsp" class="nav-item"><span>👨‍💼</span> Gerenciar Administradores</a></li>
        ...
        <li><a href="../Addresses/processar_addresses.jsp" class="nav-item active"><span>📍</span> Gerenciar Endereços</a></li>
      ...
      <div class="crud-section">
        <div class="crud-header">
          ...
          <div class="crud-actions">
            <a href="processar_addresses.jsp" class="btn btn-secondary">
