  ...
  <div class="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li><a href="../Occurrences/processar_occurrences.jsp" class="nav-item active"><span>⚠️</span> Gerenciar Tipos de Ocorrência</a></li>
      ...
      <div class="crud-section">
        <div class="crud-header">
          ...
          <div class="crud-actions">
            <a href="processar_occurrences.jsp" class="btn btn-secondary">
