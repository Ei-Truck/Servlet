    ...
    <div class="main-content">
        <header class="content-header">
            <div class="header-left">
                ...
                <p>Cadastre e gerencie os tipos de ocorrência do sistema</p>
            </div>
            ...
            <div class="crud-section">
                <div class="crud-header">
                    ...
                    <div class="crud-actions">
                        <button onclick="window.location.href='html/Restricted-area/Pages/Occurrences/occurrences.jsp'" class="btn btn-primary">
                            <span>➕</span> Adicionar Tipo de Ocorrência
                        </button>
                    </div>
                </div>
                ...
                <div class="filters">
                    <form action="${pageContext.request.contextPath}/servlet-ocorrencias" method="get" style="display: contents;">
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" id="filtroTipoEvento" name="filtro_tipo_evento" class="filter-input"
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" id="filtroGravidade" name="filtro_gravidade" class="filter-input"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form action="${pageContext.request.contextPath}/servlet-ocorrencias" method="post" style="display:inline;" onsubmit="confirmarDeletar(event)">
