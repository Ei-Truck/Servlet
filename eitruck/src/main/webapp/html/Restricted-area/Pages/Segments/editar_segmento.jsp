...
<head>
    ...
    <title>Editar Segmento - Ei Truck</title>
    ...
    <div class="main-content">
        <header class="content-header">
            <div class="header-left">
                ...
                <p>Atualize os dados do segmento</p>
            </div>
                    ...
                    <form action="${pageContext.request.contextPath}/servlet-segmentos" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control"
                                   value="${segmento.nome != null ? segmento.nome : ''}" required>
                        </div>

                        <div class="form-group">
                            <label for="descricao">Descrição:</label>
                            <input type="text" name="descricao" id="descricao" class="form-control"
                                   value="${segmento.descricao != null ? segmento.descricao : ''}" required>
                        </div>

                        <div class="form-actions">
                            <button type="submit" class="btn btn-success">Atualizar Segmento</button>
                            <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/servlet-segmentos?acao_principal=buscar&sub_acao=buscar_todos'"
