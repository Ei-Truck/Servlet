  ...
  <div class="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li><a href="../Segments/processar_segments.jsp" class="nav-item active"><span>📁</span> Gerenciar Segmentos</a></li>
      ...
      <div class="crud-section">
        <div class="crud-header">
          ...
          <div class="crud-actions">
            <a href="processar_segments.jsp" class="btn btn-secondary">
