...
<head>
    ...
    <title>Editar Unidade - Ei Truck</title>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/servlet-unidade?acao=buscar&sub_acao=buscar_todos" class="nav-item active">
    ...
    <div class="main-content">
        <header class="content-header">
            <div class="header-left">
                ...
                <p>Atualize os dados da unidade</p>
            </div>
                    ...
                    <form action="${pageContext.request.contextPath}/servlet-unidade" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="id_segmento" id="id_segmento" class="form-control"
                                       value="${unidade.idSegmento != null ? unidade.idSegmento : ''}" required>
                            </div>

                            <div class="form-group">
                                <label for="id_endereco">ID do Endereço:</label>
                                <input type="text" name="id_endereco" id="id_endereco" class="form-control"
                                       value="${unidade.idEndereco != null ? unidade.idEndereco : ''}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control"
                                   value="${unidade.nome != null ? unidade.nome : ''}" required>
                        </div>

                        <div class="form-actions">
                            <button type="submit" class="btn btn-success">Atualizar Unidade</button>
                            <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/servlet-unidade?acao_principal=buscar&sub_acao=buscar_todos'"
