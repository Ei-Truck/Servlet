                        ...
                        <div class="filter-group1">
                            <div class="filter-group">
                                ...
                                <input type="number" class="filter-input" name="filter-id"
                                       placeholder="Filtrar por ID..." value="<%= request.getParameter("filter-id") != null ? request.getParameter("filter-id") : "" %>">
                            </div>
                            <div class="filter-group">
                                <label for="filter-nome">Nome</label>
                                <input type="text" class="filter-input" name="filter-nome"
                                       placeholder="Filtrar por nome..." value="<%= request.getParameter("filter-nome") != null ? request.getParameter("filter-nome") : "" %>">
                            </div>
                            <div class="filter-group">
                                <label for="filter-cpf">CPF</label>
                                <input type="text" class="filter-input" name="filter-cpf"
                                       placeholder="Filtrar por CPF..." value="<%= request.getParameter("filter-cpf") != null ? request.getParameter("filter-cpf") : "" %>">
                            </div>
                            <div class="filter-group">
                                <label for="filter-email">E-mail</label>
                                <input type="text" class="filter-input" name="filter-email"
                                       placeholder="Filtrar por e-mail..." value="<%= request.getParameter("filter-email") != null ? request.getParameter("filter-email") : "" %>">
                            </div>
                        </div>
                        <div class="filter-group">
