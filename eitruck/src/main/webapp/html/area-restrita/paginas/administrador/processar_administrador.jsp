            ...
            <div class="crud-section">
                <div class="crud-header">
                    ...
                    <div class="crud-actions">
                        <button onclick="window.location.href='html/area-restrita/paginas/administrador/administrador.jsp'" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form action="${pageContext.request.contextPath}/servlet-administrador" method="post" style="display:inline;" onsubmit="confirmarDeletar(event)">
