...
<div class="admin-container">
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                <li><a href="${pageContext.request.contextPath}/dashboard" class="nav-item"><span><i
                        class="fas fa-chart-bar"></i></span> Dashboard</a></li>

                <li>
                    <a href="${pageContext.request.contextPath}/servlet-administrador?acao=buscar&sub_acao=buscar_todos"
                       class="nav-item">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/servlet-analista?acao=buscar&sub_acao=buscar_todos"
                       class="nav-item">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/servlet-segmentos?acao=buscar&sub_acao=buscar_todos"
                       class="nav-item">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/servlet-unidade?acao=buscar&sub_acao=buscar_todos"
                       class="nav-item">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/servlet-enderecos?acao=buscar&sub_acao=buscar_todos"
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/servlet-ocorrencias?acao=buscar&sub_acao=buscar_todos"
                       class="nav-item">
                        <span><i class="fas fa-exclamation-triangle"></i></span> Gerenciar Tipos de Ocorrência
                    </a>
                </li>

                <li><a href="${pageContext.request.contextPath}/logout" class="nav-item logout"><span><i
    ...
    <div class="main-content">
        <header class="content-header">
            <div class="header-left">
                ...
                <p>Cadastre e consulte endereços do sistema</p>
            </div>
            ...
            <div class="crud-section">
                <div class="crud-header">
                    ...
                    <div class="crud-actions">
                        <button type="button"
                                onclick="window.location.href='${pageContext.request.contextPath}/servlet-enderecos?acao_principal=buscar&sub_acao=buscar_todos'"
