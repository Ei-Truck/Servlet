            ...
            <div class="crud-section">
                <div class="crud-header">
                    ...
                    <div class="crud-actions">
                        <button onclick="window.location.href='html/area-restrita/paginas/analista/analista.jsp'" class="btn btn-primary">
                ...
                <div class="filters">
                    <form action="${pageContext.request.contextPath}/servlet-analista" method="get" style="display: contents;">
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" id="filtroNomeUnidade" name="filtro_nome_unidade" class="filter-input"
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" id="filtroNomeCompleto" name="filtro_nome_completo" class="filter-input"
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" id="filtroCargo" name="filtro_cargo" class="filter-input"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form action="${pageContext.request.contextPath}/servlet-analista" method="post" style="display:inline;" onsubmit="confirmarDeletar(event)">
