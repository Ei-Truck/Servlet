    ...
    <div class="main-content">
        <header class="content-header">
            <div class="header-left">
                ...
                <p>Atualize os dados do tipo de ocorrência</p>
            </div>
                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/servlet-ocorrencias" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="pontuacao" id="pontuacao" class="form-control"
                                       ...
                                       min="1" max="1000" step="1" placeholder="Pontuação numérica">
                            </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-success">Atualizar Tipo de Ocorrência</button>
                            <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/servlet-ocorrencias?acao_principal=buscar&sub_acao=buscar_todos'"
